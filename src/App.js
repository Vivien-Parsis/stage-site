    ...
    <main>
      ...
      <Routes>
        <Route path="/" element={<Navigation/>}>
          ...
          <Route path="article-1" element={<div>article-1 (wip)</div>}/>
          <Route path="article-2" element={<div>article-2 (wip)</div>}/>
          <Route path="article-3" element={<div>article-3 (wip)</div>}/>
