const Presentation = () => {
    return (
        <>
        <p>
        <span>Nous sommes implantés à Boissy Saint Léger depuis 30 ans, nous avons une longue expérience de l'omnipratique et sommes depuis plusieurs années spécialisés en chirurgie orale.</span>
        <span>pratiquons la chirurgie buccale, parodontale et plus particulièrement la chirurgie pré-implantaire et implantaire.</span>
        <span>Mon métier est une vocation et ma préoccupation première a toujours été le soin bénéfique apporté au patient ainsi que la collaboration avec mes confrères dentistes pour élaborer et proposer un plan de traitement adapté.</span>
